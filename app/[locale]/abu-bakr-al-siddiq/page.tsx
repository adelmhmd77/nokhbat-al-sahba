"use client";
import Link from 'next/link';npm ru
...
{/* 6. قسم معجزة الغار (ثاني اثنين) */}
      ...
      {/* سيكشن الانتقال للصحابي التالي (سيدنا عمر) */}
      <section className="relative w-full max-w-5xl mx-auto px-6 py-20 z-10 border-t border-white/5 mt-20">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <Link href="/umar-ibn-al-khattab" className="group relative">
            {/* توهج خلف الزرار */}
          ...
          <p className="text-blue-100/50 font-tufuli text-sm mt-2">
            انتقل لقراءة قصة فاروق الأمة وملهمها
          </p>
        </div>
      </section>
    </main>
